...
public class Hour {
    ...
    public static final String SIXTEEN_TO_EIGHTEEN = "16,00-17,50";
    public static final String EIGHTEEN_TO_TWENTY = "18,00-19,50";
    public static final String TWENTY_TO_TWENTYTWO = "20,00-21,50";
}
